...
public class DATA {
    ...
    public static final String DOMAIN_API_SEARCH_INPUT_BOX_DATA = DOMAIN+"/search/input-box-recommend?keyword=";//需要关键字  搜索框的内容提示的数据接口  搜索的内容比较少
    ...
    public static final String DOMAIN_API_ECHO_HOT_DATA = DOMAIN+"/sound/exploration";// echo 热门页  周榜和今日热门数据接口
    public static final String DOMAIN_API_SEARCH_DATA = "http://link.hhtjim.com/api/echo.php?";// 需要参数：keyword=love&page=2&token=XXXX
    public static final String DOMAIN_API_CELEBRITY_RECOMMEND_START_DATA = DOMAIN+"/user/";// 名人页  推荐明星数据页
